...
bin/client -f /tmp/socket.sk -w ${CWD}/small_files,10 -x -R 10 -d ${CWD}/output_stress_test 
echo "FIRST DONE"
bin/client -f /tmp/socket.sk -W ${CWD}/medium_files/medium_0.txt -u ${CWD}/medium_files/medium_0.txt 
echo "SECOND DONE"
sleep 2
bin/client -f /tmp/socket.sk -W ${CWD}/test_2/initial_file_0.txt -u ${CWD}/test_2/initial_file_0.txt
echo "THIRD DONE"
sleep 2
